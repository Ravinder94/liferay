...
public class BranchUtil {
	...
	public static Branch findByUuid_First(
		...
		throws com.mx.ace.exception.NoSuchBranchException {
	...
	private static ServiceTracker<BranchPersistence, BranchPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(BranchPersistence.class);

		ServiceTracker<BranchPersistence, BranchPersistence> serviceTracker =
			new ServiceTracker<BranchPersistence, BranchPersistence>(
				bundle.getBundleContext(), BranchPersistence.class, null);
