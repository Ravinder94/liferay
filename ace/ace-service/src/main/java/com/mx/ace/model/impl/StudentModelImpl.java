...
import com.mx.ace.model.StudentModel;
...
/**
 * The base model implementation for the Student service. Represents a row in the &quot;ACE_Student&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class StudentModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "ACE_Student";
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"mobileNumber", Types.BIGINT}, {"branchId", Types.BIGINT}
	};
	...
	public static final String TABLE_SQL_CREATE =
		"create table ACE_Student (uuid_ VARCHAR(75) null,id_ LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,email VARCHAR(75) null,mobileNumber LONG,branchId LONG)";

	public static final String TABLE_SQL_DROP = "drop table ACE_Student";

	public static final String ORDER_BY_JPQL = " ORDER BY student.name ASC";

	public static final String ORDER_BY_SQL = " ORDER BY ACE_Student.name ASC";
	...
	static {
		...
		attributeSetterBiConsumers.put(
			"mobileNumber",
			(BiConsumer<Student, Long>)Student::setMobileNumber);
