...
package com.mx.ace.service.persistence.impl;
...
import com.mx.ace.exception.NoSuchBranchException;
import com.mx.ace.model.Branch;
import com.mx.ace.model.impl.BranchImpl;
import com.mx.ace.model.impl.BranchModelImpl;
import com.mx.ace.service.persistence.BranchPersistence;
import com.mx.ace.service.persistence.impl.constants.ACEPersistenceConstants;
 ...
 * @generated
 */
@Component(service = BranchPersistence.class)
public class BranchPersistenceImpl
	...
	protected void cacheUniqueFindersCache(BranchModelImpl branchModelImpl) {
		...
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, branchModelImpl, false);
	}
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new BranchModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", Branch.class.getName()));
	...
	@Override
	@Reference(
		target = ACEPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = ACEPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	...
	static {
		try {
			Class.forName(ACEPersistenceConstants.class.getName());
		}
	...
	private static class BranchModelArgumentsResolver
