package com.softwaresavvyblog.command.classes.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=LiferayCommandClassExample",
...
public class LiferayCommandClassExamplePortlet extends MVCPortlet {
}