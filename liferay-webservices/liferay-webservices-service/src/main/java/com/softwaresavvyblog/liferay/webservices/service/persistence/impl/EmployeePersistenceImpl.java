...
package com.softwaresavvyblog.liferay.webservices.service.persistence.impl;
...
import com.softwaresavvyblog.liferay.webservices.exception.NoSuchEmployeeException;
import com.softwaresavvyblog.liferay.webservices.model.Employee;
import com.softwaresavvyblog.liferay.webservices.model.impl.EmployeeImpl;
import com.softwaresavvyblog.liferay.webservices.model.impl.EmployeeModelImpl;
import com.softwaresavvyblog.liferay.webservices.service.persistence.EmployeePersistence;
import com.softwaresavvyblog.liferay.webservices.service.persistence.impl.constants.WebServicesPersistenceConstants;
...
public class EmployeePersistenceImpl
	...
	@Override
	@Reference(
		target = WebServicesPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = WebServicesPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	...
	static {
		try {
			Class.forName(WebServicesPersistenceConstants.class.getName());
		}
